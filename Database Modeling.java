...
1) 개념적 데이터 모델링: 비즈니스 영역으로부터 데이터 수집
		- Collection 추출
		- Field 추출
		- Document & Tree Doc. 추출 (Index)
		- Collection Diagram

2) 논리적 데이터 모델링: Document 구조에 따라 분석/설계
		- Data Type 결정
		- Validator 설계 (유효성)
...
RDBMS: Entry간의 Relationship(관계) 중심으로 데이터의 무결성 보장
		Table간의 Joing을 유발함으로서 작업량 증가, 검색 성능 저하

NoSQL: 중첩 데이터 구조를 채택하여 불필요한 Join을 최소화
